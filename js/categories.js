...
export const CATEGORIES = [
  ...
  },
  {
    ...
    puzzles: [
      ...
      { icons: ['💬'], answer: 'CHIKA', difficulty: 'easy' },
      ...
      { icons: ['💪', '🔄'], answer: 'WERPA', difficulty: 'hard' },
  ...
  },
  {
    ...
    puzzles: [
      ...
      { icons: ['🔨'], answer: 'ANG PANDAY', difficulty: 'medium' },
      ...
      { icons: ['👩', '📖', '⏳'], answer: 'MARIA CLARA AT IBARRA', difficulty: 'hard' },
      ...
      { icons: ['🚿', '🚶'], answer: 'LIGO NA U LAPIT NA ME', difficulty: 'hard' },
    ],
  },
  {
    ...
    puzzles: [
      ...
      // hard
      { icons: ['⛪', '📜'], answer: 'BARASOAIN CHURCH', difficulty: 'hard' },
      { icons: ['✌️', '🛣️'], answer: 'EDSA', difficulty: 'hard' },
      { icons: ['🕳️', '🌊'], answer: 'PUERTO PRINCESA UNDERGROUND RIVER', difficulty: 'hard' },
      { icons: ['⛪', '🪨'], answer: 'SAN AGUSTIN CHURCH', difficulty: 'hard' },
      { icons: ['🐄', '🌾'], answer: 'BATANES', difficulty: 'hard' },
      { icons: ['⛵', '🪙'], answer: 'MANILA GALLEON', difficulty: 'hard' },
    ],
  },
  {
