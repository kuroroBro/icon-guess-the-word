...
// timed-wordy's room.js. Simpler than that sibling implementation because
// only the Host ever acts — the Display is a pure render target and never
// sends a game action, so there's no per-connection role/permission system
// here at all (see plan.md's Networking model).

const ID_PREFIX = 'iguess-room-'; // distinct from timed-wordy's xsec-room-
